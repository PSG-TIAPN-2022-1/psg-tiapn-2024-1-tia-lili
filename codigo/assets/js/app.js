...
function registrar_usuario() {
    console;log("Função registrar_usuario");
    // Função para enviar os dados do formulário para o backend
    $('#registerForm').submit(function(event) {
        // Prevenir o envio tradicional do formulário
        event.preventDefault();

        // Capturar os dados do formulário
        var formData = {
            nome: $('#nome').val().trim(),
            telefone: $('#telefone').val().trim().replace(/\D/g, ''), // Remover não dígitos
        ...
        // URL do endpoint de backend para enviar os dados do formulário
        var url = 'URL_DO_BACKEND';
        ...
        .done(function(data) {
            // Resposta do backend em caso de sucesso
            console.log(data); // Exemplo: exibir resposta no console
            alert('Formulário enviado com sucesso!'); // Exemplo: mensagem de sucesso
        ...
        .fail(function(error) {
            ...
            console.error(error); // Exemplo: exibir erro no console
            alert('Erro ao enviar formulário. Por favor, tente novamente.'); // Exemplo: mensagem de erro
        });
    });
}
